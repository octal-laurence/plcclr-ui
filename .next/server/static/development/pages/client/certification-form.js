...
function (_React$Component) {
  ...
  function FingerPrint(props) {
    ...
    _this.saveFingerPrint = _this.saveFingerPrint.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
  ...
  _createClass(FingerPrint, [{
    ...
    value: function renderFingerPrintProjector() {
      ...
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_4__["default"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "button",
        onClick: function onClick(e) {
          _this2.setState({
    ...
    key: "saveFingerPrint",
    value: function saveFingerPrint() {
      var _this4 = this;

      var supreme = this.supreme;
      var localStorage = window.REGIONFINGERPRINT.localStorage;
      ...
      if (localStorage.getItem("imageSrc") == "" || localStorage.getItem("imageSrc") == null || document.getElementById('imagediv').innerHTML == "") {
        ...
        fetch(localStorage.getItem("imageSrc")).then(function (res) {
          return res.blob();
        }).then(function (blob) {
        ...
        supreme.setState({
          applicantFingerPrint: _objectSpread({}, supreme.state.applicantFingerPrint, _defineProperty({}, this.state.fingerPrintSubj, localStorage.getItem("imageSrc")))
        }, function () {
          window.REGIONFINGERPRINT.onStop();
...
/***/ "./pages/client/certification-form/idPhoto.js":
/*!****************************************************!*\
  !*** ./pages/client/certification-form/idPhoto.js ***!
  \****************************************************/
/*! exports provided: default */
...
/* harmony import */ var react_dom__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react_dom__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _ui_box__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../ui/box */ "./pages/ui/box.js");
/* harmony import */ var _ui_button__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../ui/button */ "./pages/ui/button.js");
/* harmony import */ var _ui_library_webcam__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../ui/library/webcam */ "./pages/ui/library/webcam.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(IDPhoto, _React$Component);

  function IDPhoto(props) {
    var _this;

    _classCallCheck(this, IDPhoto);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(IDPhoto).call(this, props));
    _this.supreme = props.supreme;
    _this.updateStateApplicantIDPhoto = _this.updateStateApplicantIDPhoto.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.cameraSnapshot = _this.cameraSnapshot.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }

  _createClass(IDPhoto, [{
    key: "switchCamera",
    value: function switchCamera() {
      var control = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
      var cameraProjection = document.getElementById('cameraProjection');
    ...
    key: "updateStateApplicantIDPhoto",
    value: function updateStateApplicantIDPhoto() {
      var newState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      var supreme = this.supreme;
      supreme.setState({
        applicantIDPhoto: _objectSpread({}, supreme.state.applicantIDPhoto, newState)
      });
    }
  }, {
    key: "cameraSnapshot",
    value: function cameraSnapshot() {
      var updateStateApplicantIDPhoto = this.updateStateApplicantIDPhoto;
    ...
    value: function componentDidMount() {
      // this.switchCamera();
      Object(_ui_library_webcam__WEBPACK_IMPORTED_MODULE_4__["default"])(window);
      Webcam.set({
        width: 320,
        height: 240,
        image_format: 'jpeg',
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_2__["default"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "ID Photo"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Require Identification Image to be taken.")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_2__["default"], {
        ...
        src: supreme.state.applicantIDPhoto.blob
      })), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", {
        type: "hidden",
        id: "captured_text"
      }))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
...
/* harmony default export */ __webpack_exports__["default"] = (IDPhoto);
...
/* harmony import */ var _components_sidebar__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../components/sidebar */ "./pages/components/sidebar.js");
/* harmony import */ var _ui_box__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../ui/box */ "./pages/ui/box.js");
/* harmony import */ var _ui_inputText__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../ui/inputText */ "./pages/ui/inputText.js");
/* harmony import */ var _ui_button__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../ui/button */ "./pages/ui/button.js");
/* harmony import */ var _applicantInfo__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./applicantInfo */ "./pages/client/certification-form/applicantInfo.js");
/* harmony import */ var _idPhoto__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./idPhoto */ "./pages/client/certification-form/idPhoto.js");
/* harmony import */ var _fingerPrint__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./fingerPrint */ "./pages/client/certification-form/fingerPrint.js");
/* harmony import */ var _signature__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./signature */ "./pages/client/certification-form/signature.js");
/* harmony import */ var _summary__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./summary */ "./pages/client/certification-form/summary.js");
/* harmony import */ var _middleware_router__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ../../../middleware/router */ "./middleware/router.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_React$Component) {
  ...
  _createClass(CertificationForm, [{
    ...
    value: function switchPageHandler(tab) {
      ...
      var inputValidation = function (tabName) {
        var _Object$entries$find = Object.entries(_this2.state.navTabs).find(function (_ref) {
          ...
          return v === 1;
            ...
            currentTab = _Object$entries$find2[0];

        var invalid = Object.entries(_this2.state[currentTab] || {}).filter(function (_ref3) {
      ...
      if (inputValidation.length === 0) {
        ...
        var invalidInputList = inputValidation.reduce(function (notifyInvalid, _ref5) {
          var _ref6 = _slicedToArray(_ref5, 1),
              item = _ref6[0];

          notifyInvalid += "".concat(item, "\n");
          return notifyInvalid;
        }, '');
        alert("Check the following record, must be required & valid entry\n".concat(invalidInputList));
      }
    }
  }, {
    ...
    value: function submitApplicantEntry() {
      ...
      this.setState({
        editing: _objectSpread({}, this.state.editing, {
          loading: true
        })
      });
      ...
      var applicantData = _objectSpread({}, this.state.applicantInfo, {
        ...
        applicantFingerPrint: function (input) {
          var fingerPrints = Object.entries(input).map(function (_ref7) {
            var _ref8 = _slicedToArray(_ref7, 2),
                k = _ref8[0],
                v = _ref8[1];

            return _defineProperty({}, k, v.split(',')[1]);
            ...
            var _Object$entries = Object.entries(item),
                ...
                k = _Object$entries2$[0],
                _Object$entries2$$ = _Object$entries2$[1],
                v = _Object$entries2$$ === void 0 ? '' : _Object$entries2$$;
      ...
      Object(_middleware_router__WEBPACK_IMPORTED_MODULE_16__["default"])("/police-clearance-certification/new", applicantData).then(function (_ref10) {
        var _ref11 = _slicedToArray(_ref10, 1),
            certification = _ref11[0].certification;

        alert('Save Success');

        var _certification$Rid$s = certification['@rid'].split('#'),
            _certification$Rid$s2 = _slicedToArray(_certification$Rid$s, 2),
            rid = _certification$Rid$s2[1];

        window.location.href = "/certification-preview?id=".concat(rid);
      }).catch(function (err) {
        alert(err.message);

        _this3.setState({
          editing: _objectSpread({}, _this3.state.editing, {
            loading: false,
            error: err.message
          })
        });
    ...
    value: function componentDidMount() {
      this.setState({
        navTabs: _objectSpread({}, this.state.navTabs, {
          applicantInfo: 1
        })
      });
    }
    ...
    value: function renderNavTabs() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          ...
          className: "nav-item",
          onClick: function onClick(e) {
            _this4.switchPageHandler(item.tab);
          }
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          className: "nav-link ".concat(_this4.state.navTabs[item.tab] === 1 && "active"),
          href: "#"
        }, item.label));
      }));
    }
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_layout__WEBPACK_IMPORTED_MODULE_5__["default"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_8__["default"], null, this.renderNavTabs(), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        id: "formContents",
        className: "container"
        ...
        onSubmit: function onSubmit(e) {
          ...
          _this5.submitApplicantEntry();
        }
      }, this.state.navTabs.applicantInfo === 1 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_applicantInfo__WEBPACK_IMPORTED_MODULE_11__["default"], {
        supreme: this
      }), this.state.navTabs.applicantIDPhoto === 1 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_idPhoto__WEBPACK_IMPORTED_MODULE_12__["default"], {
        supreme: this
      }), this.state.navTabs.applicantFingerPrint === 1 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_fingerPrint__WEBPACK_IMPORTED_MODULE_13__["default"], {
        supreme: this
      }), this.state.navTabs.applicantSignature === 1 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_signature__WEBPACK_IMPORTED_MODULE_14__["default"], {
        supreme: this
      }), this.state.navTabs.finalization === 1 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_summary__WEBPACK_IMPORTED_MODULE_15__["default"], {
        supreme: this
        ...
        className: "container",
        align: "right"
      }, this.state.editing.loading ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, "Please Wait, Record is on Processing...") : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", {
        type: "submit"
      }, "Save")))))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(next_head__WEBPACK_IMPORTED_MODULE_3___default.a, null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("title", null, "Police Clearance"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("script", {
  ...
  _createClass(Signature, [{
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_3__["default"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Signature"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Write Digital Signature.")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_3__["default"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", {
        ...
        type: "button",
        onClick: function onClick(e) {
          _this2.supreme.switchPageHandler('finalization');
        }
...
/***/ "./pages/client/certification-form/summary.js":
/*!****************************************************!*\
  !*** ./pages/client/certification-form/summary.js ***!
  \****************************************************/
/*! exports provided: default */
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_2__["default"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, "Summary"), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", null, "Information Summary")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_2__["default"], null, Object.entries(supreme.state.applicantInfo).map(function (_ref) {
        ...
        return [react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_2__["default"], {
          key: k
        }, applicantInfo[k].label, " :\xA0", react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("u", null, v))), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("br", null)].map(function (elem) {
          return elem;
        });
      })));
    }
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! styled-components */ "styled-components");
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(styled_components__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _container__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./container */ "./pages/components/container.js");
...
})(["list-style-type:none;margin:0;padding:0;width:100%;background-color:#f1f1f1;"]);
...
})(["display:block;color:#000;padding:8px 16px;text-decoration:none;&:hover{background-color:#555;color:white;}"]);
/* harmony default export */ __webpack_exports__["default"] = (function (_ref) {
  var items = _ref.items;
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(NavList, null, items.map(function (_ref2) {
    var _ref3 = _slicedToArray(_ref2, 2),
        _ref3$ = _ref3[0],
        label = _ref3$ === void 0 ? 'label' : _ref3$,
        _ref3$2 = _ref3[1],
        route = _ref3$2 === void 0 ? '/' : _ref3$2;

    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(Alink, {
      href: route
    }, label));
  }));
});
  ...
  _createClass(Sidebar, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_container__WEBPACK_IMPORTED_MODULE_1__["default"], {
        ...
        items: [["certification-form", "/certification-form"], ["certification-entries", "/certification-entries"]]
      })));
    }
  }]);
    ...
    dispatch: function dispatch() {
      ...
      if (this.hooks[name] && this.hooks[name].length) {
        for (var idx = 0, len = this.hooks[name].length; idx < len; idx++) {
          ...
          } else if (_typeof(hook) == 'object' && hook.length == 2) {
...
module.exports = __webpack_require__(/*! ./pages/client/certification-form/index.js */"./pages/client/certification-form/index.js");
