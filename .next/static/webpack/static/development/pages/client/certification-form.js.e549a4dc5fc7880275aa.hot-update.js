...
function (_React$Component) {
  ...
  _createClass(CertificationForm, [{
    ...
    value: function submitApplicantEntry() {
      ...
      console.log(applicantData); // fetch('http://localhost:8000/PoliceClearanceCertification/testpush', {
      ...
      plcclr.newApplicantEntry(applicantData).then(function (response) {
...
//# sourceMappingURL=certification-form.js.e549a4dc5fc7880275aa.hot-update.js.map