...
/* harmony import */ var _middleware_router__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../middleware/router */ "./middleware/router.js");
/* harmony import */ var _model_policeClearanceCertifications__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../../../model/policeClearanceCertifications */ "./model/policeClearanceCertifications.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function (_React$Component) {
  ...
  function CertificationForm(props) {
    ...
    var addMode = typeof id === 'undefined';
    _this.navTabs = [{
      tab: 'applicantInfo',
      label: 'Start'
    }, {
  ...
  _createClass(CertificationForm, [{
    ...
    value: function submitApplicantEntry() {
      ...
      var certification = this.state.addMode ? {
        action: _model_policeClearanceCertifications__WEBPACK_IMPORTED_MODULE_15__["newApplicationEntry"],
        input: applicantData
      } : {
        action: _model_policeClearanceCertifications__WEBPACK_IMPORTED_MODULE_15__["editApplicationEntry"],
        input: _objectSpread({}, applicantData, {
          id: this.props.router.query.id
        })
      };
      var input = certification.input,
      ...
      action(input).then(function (result) {
        alert('Save Success');
    ...
    value: function getApplicationEntry() {
      var _this4 = this;
      ...
      Object(_model_policeClearanceCertifications__WEBPACK_IMPORTED_MODULE_15__["getApplicationEntry"])("#".concat(this.props.router.query["id"])).then(function (data) {
        var applicant = data.applicant,
            address = data.address,
            certification = _objectWithoutProperties(data, ["applicant", "address"]);

        _this4.setState({
          editing: _objectSpread({}, _this4.state.editing, {
            loading: false
          }),
          applicantInfo: _objectSpread({}, Object.entries(_this4.state.applicantInfo).map(function (_ref10) {
            ...
            return _objectSpread({}, obj, _defineProperty({}, k, applicant[k]));
          }, {}), {
          ...
          applicantFingerPrint: {
            leftThumb: "data:image/jpeg;base64,".concat(applicant.applicantFingerPrints.leftThumb),
            rightThumb: "data:image/jpeg;base64,".concat(applicant.applicantFingerPrints.rightThumb)
          },
          applicantSignature: {
    ...
    value: function renderNavTabs() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", {
        ...
        return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
          ...
          className: "nav-item",
          onClick: function onClick(e) {
            _this5.switchPageHandler(item.tab);
          }
        }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
          className: "nav-link ".concat(_this5.state.navTabs[item.tab] === 1 && "active"),
          href: "#"
        }, item.label));
      }));
    }
    ...
    value: function render() {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_layout__WEBPACK_IMPORTED_MODULE_5__["default"], {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_6__["default"], null, this.renderNavTabs(), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_6__["default"], {
        id: "formContents",
        className: "container"
        ...
        supreme: this
      }), this.state.navTabs.finalization === 1 && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_6__["default"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_summary__WEBPACK_IMPORTED_MODULE_13__["default"], {
        supreme: this
      }), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("hr", null), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_6__["default"], {
        className: "container",
        align: "right"
      }, this.state.editing.loading ? react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("label", null, "Please Wait, Record is on Processing...") : react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_button__WEBPACK_IMPORTED_MODULE_8__["default"], {
        type: "submit"
