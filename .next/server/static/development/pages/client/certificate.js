...
function (_React$Component) {
  ...
  _createClass(Certificate, [{
    ...
    value: function getCertificate() {
      ...
      Object(_model_policeClearanceCertifications__WEBPACK_IMPORTED_MODULE_9__["getCertificate"])("#".concat(this.certificateId)).then(function (result) {
        _this2.setState({
          loading: false,
          data: result
        });
    ...
    value: function render() {
      ...
      }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_button__WEBPACK_IMPORTED_MODULE_8__["default"], null, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("a", {
        href: "/certificate-print?id=".concat(this.state.data["@rid"]),
        target: "_blank"
      }, "Print")))), this.state.error && react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_ui_box__WEBPACK_IMPORTED_MODULE_5__["default"], null, this.state.error)));
    }
  }]);
