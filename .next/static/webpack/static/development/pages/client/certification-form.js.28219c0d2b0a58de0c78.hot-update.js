...
function (_React$Component) {
  ...
  _createClass(FingerPrint, [{
    ...
    value: function componentDidUpdate() {
      console.log(this.state.fingerPrintSubj);

      if (this.state.fingerPrintSubj !== '') {
        console.log(window.REGIONFINGERPRINT);
      }
    }
  }, {
...
//# sourceMappingURL=certification-form.js.28219c0d2b0a58de0c78.hot-update.js.map